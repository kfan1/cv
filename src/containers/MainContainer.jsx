...
export default function MainContainer({ exit }) {
  return (
    <>
      ...
      <div className={styles.bigBox}>
        <div className={styles.name}>
          ...
          <p className={styles.myIntro}>
            ...
            empathetic engineer, and enjoys all things math, science, and technology. Currently residing in Philly with
            my black cat, Toothless and my girlfriend, Stephanie, and still doing the same things 20 years later. Follow
            me while I continue to become a better programmer. Take a look at the projects I'm currently working on my
            GitHub.
          </p>
        </div>
